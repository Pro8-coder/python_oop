...
классов класса Translator, используя коллекцию-словарь. (Хранить связки в
коллекции __dict__ не нужно! Определите для этого отдельный словарь.)
