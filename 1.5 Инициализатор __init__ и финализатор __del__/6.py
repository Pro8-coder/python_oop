...
class MotherBoard:
    def __init__(self, name, cpu, *m_slots):
        self.name = name
        self.cpu = cpu
        self.total_mem_slots = 4
        self.mem_slots = m_slots[:self.total_mem_slots]
...
mb = MotherBoard("Gigabyte", CPU("Intel", 2500), Memory("AMD", 8000),
                 Memory("AMD", 8000), Memory("AMD", 8000), Memory("AMD", 8000))
